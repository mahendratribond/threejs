...
<body>
    ...
    <script type="module">
        ...
        document.querySelector('.applyTextures').addEventListener('change', function() {
            ...
            // const numObjects = document.getElementById('numObjects').value || null;
            const numObjects =  '';
            const queryParams = []
            if (innerTexture && borderTexture) {
                queryParams.push(`innerTexture=${innerTexture}`);
            }
            if (innerTexture && borderTexture) {
                queryParams.push(`borderTexture=${borderTexture}`);
            }
            queryParams.push(`numObjects=${numObjects}`);
