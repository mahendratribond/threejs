...
let renderer, canvas, scene, camera, stats, controls, csm, csmHelper, groupFrame, cropper, ambientLight, directionalLight1, directionalLight2, directionalLight3, directionalLight4, directionalLight5, directionalLight6, directionalLight7, directionalLight8, poinrLight, spotLight1, spotLight2;
let ground, currentTopFrame, currentBaseFrame, currentBaseFrameColor, topFramCropedImage, mainFramCropedImage;
const frames = {};
...
function init() {
    ...
    for (const [key, value] of Object.entries(singleStandDaeFiles)) {
        ...
        loader.load('.' + generatedDir + value.fileName, function (collada) {
            ...
            // frames[key].colorSpace = THREE.SRGBColorSpace;
...
scene.add(groundMesh);
    ...
    // Ambient Light
    ambientLight = new THREE.AmbientLight(0xffffff, 2.3); // Adjust intensity
    ambientLight.position.set(1, 1, 1).normalize();
    scene.add(ambientLight);

    spotLight1 = new THREE.SpotLight(0xffffff, 500);
    spotLight1.name = 'Spot Light';
    spotLight1.angle = Math.PI;
    spotLight1.penumbra = 0.3;
    spotLight1.position.set(20, 20, 20);
    spotLight1.castShadow = true;
    spotLight1.shadow.camera.near = 30;
    spotLight1.shadow.camera.far = 300;
    spotLight1.shadow.mapSize.width = 2024;
    spotLight1.shadow.mapSize.height = 2024;
    // scene.add(spotLight1);
    // scene.add(new THREE.CameraHelper(spotLight1.shadow.camera));

    // spotLight2 = new THREE.SpotLight(0xffffff, 500);
    ...
    directionalLight1.name = 'Dir. Light';
    directionalLight1.position.set(30, 60, 0);
    directionalLight1.castShadow = true;
    directionalLight1.shadow.camera.near = 1;
    directionalLight1.shadow.camera.far = 150;
    ...
    directionalLight2.position.set(-40, 40, -40);//.normalize();
    directionalLight2.castShadow = true;
    directionalLight2.shadow.camera.near = 1;
    directionalLight2.shadow.camera.far = 80;
    ...
    directionalLight3.position.set(40, -28, -40);//.normalize();
    directionalLight3.castShadow = true;
    directionalLight3.shadow.camera.near = 1;
    directionalLight3.shadow.camera.far = 80;
    directionalLight3.shadow.camera.right = 15;
    directionalLight3.shadow.camera.left = - 15;
    directionalLight3.shadow.camera.top = 15;
    directionalLight3.shadow.camera.bottom = - 15;
    ...
    directionalLight4.position.set(-40, -28, 40);//.normalize();
    directionalLight4.castShadow = true;
    directionalLight4.shadow.camera.near = 1;
    directionalLight4.shadow.camera.far = 80;
    directionalLight4.shadow.camera.right = 15;
    directionalLight4.shadow.camera.left = - 15;
    directionalLight4.shadow.camera.top = 15;
    directionalLight4.shadow.camera.bottom = - 15;
    directionalLight4.shadow.mapSize.width = 1024;
    directionalLight4.shadow.mapSize.height = 1024;
    scene.add(directionalLight4);

    // directionalLight5 = new THREE.DirectionalLight(0xffffff, 0.7);
    // directionalLight5.position.set(-40, -40, -40);//.normalize();
    // scene.add(directionalLight5);

    // directionalLight6 = new THREE.DirectionalLight(0xffffff, 0.7);
    // directionalLight6.position.set(40, -40, 40);//.normalize();
    // scene.add(directionalLight6);

    // directionalLight7 = new THREE.DirectionalLight(0xffffff, 0.7);
    // directionalLight7.position.set(-40, 40, 40);//.normalize();
    // scene.add(directionalLight7);

    // directionalLight8 = new THREE.DirectionalLight(0xffffff, 0.7);
    // directionalLight8.position.set(40, 40, -40);//.normalize();
    // scene.add(directionalLight8);

    // poinrLight = new THREE.PointLight(0xff9000, 3);
    // poinrLight.position.set(20, 20, 20);//.normalize();
    // scene.add(poinrLight);

    // const poinrLightHelper = new THREE.PointLightHelper(poinrLight, 5);
    // scene.add(poinrLightHelper);
    ...
    if (directionalLight4) {
        lights.push(directionalLight4);
    }
    if (directionalLight5) {
        lights.push(directionalLight5);
    }
    if (directionalLight6) {
        lights.push(directionalLight6);
    }
    if (directionalLight7) {
        lights.push(directionalLight7);
    }
    if (directionalLight8) {
        lights.push(directionalLight8);
    }
...
function updateBaseFrameColor(frame, color) {
    ...
    // }
    // if (directionalLight5) {
    //     directionalLight5.intensity = intensity;
    // }
    // if (directionalLight6) {
    //     directionalLight6.intensity = intensity;
    // }
    // if (directionalLight7) {
    //     directionalLight7.intensity = intensity;
    // }
    // if (directionalLight8) {
    //     directionalLight8.intensity = intensity;
    // }
...
function checkAndAddToGroup() {
    if (frames.frameBase1 && frames.frameBase2 && frames.frameMain && frames.frameTop1) {
        ...
        groupFrame.traverse(function (node) {
            if (node.isMesh) {
